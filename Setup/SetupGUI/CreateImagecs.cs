...
namespace SetupGUI
{
    public partial class CreateImagecs : Form
    {
        ...
        {
            MessageBox.Show("To use this, follow these steps.\n\n1)After this message closes, your browser will start downloading Drivers.zip. Extract it into a folder anywhere (recommended on Desktop)\n\n2)Once you have extracted, click on Change and set the folder to the extracted folder.\n\n Thats it! You have an image with drivers that should mostly work on every PC!");
            System.Diagnostics.Process.Start("https://github.com/eliasailenei/PortableISO/releases/download/Drivers/Drivers.zip");

        }

        private void button8_Click(object sender, EventArgs e)
        {
            MessageBox.Show("To use this, follow these steps.\n\n1)After this message closes, your browser will start downloading winpe.wim.\n\n2)Head to your ADK location and go to Assessment and Deployment Kit\\Windows Preinstallation Environment\\amd64\\en-us\n\n3)There is already an image called winpe.wim, this is the default image,rename it to something else e.g backup.wim(keep it safe).\n\n4)Drop the downloaded winpe.wim, the program will now use this instead!\n\n Thats it! You have an image with WiFi support!");
